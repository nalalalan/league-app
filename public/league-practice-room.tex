...
Saved game-note reads & Preserve pasted game notes as readable documents while showing one all-entry takeaway, the June 30 onward game-time rank-vs-time chart, parsed game date/time, rank, Alan/Samira-owned game facts, one cached model-backed description grounded in the note's actual analysis, one punctuation-preserving justified PDF action, and one delete action per note & Reject generic, inverted, repeated, report-like, overlong, cut-off, assistant-prefaced, or team-score-derived model text before it becomes card copy, then describe the visible saved-note surface, archived PDF routes, delete boundary, and source-bounded rank boundary \\
