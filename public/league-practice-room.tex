...
Saved game-note reads & Preserve pasted game notes as readable documents while showing one all-entry takeaway, the June 30 onward rank-vs-time chart, date, rank, parsed game facts, one cached model-backed description grounded in the note's actual analysis, one PDF action, and one delete action per note & Reject generic, inverted, repeated, report-like, overlong, cut-off, or assistant-prefaced model text before it becomes card copy, then describe the visible saved-note surface, archived PDF routes, delete boundary, and source-bounded rank boundary \\
