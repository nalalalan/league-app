...
The recording review does not attempt to become a full coaching dashboard. The page gives one current improvement for the detected champion and one feedback note for every recording. The public surface now puts the recording feedback first because it is the current queue plan; champion situations remain reference material below it. After manual storyboard review of the newest full recording, the current Samira target is ``reset before lethal HP'': when lane health drops to one enemy auto or spell, the wave is no longer the objective. Each recording note also includes a short trust rationale and a collapsed full read with visible pattern, Diamond rule, queue rep, evidence, nuance, and review limit so the advice is tied to replay evidence rather than generic motivation.
