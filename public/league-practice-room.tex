...
Today note reads & Preserve current pasted notes as readable documents while showing one all-entry takeaway, date, rank, one direct description grounded in the note's actual analysis, one PDF action, and one delete action per note & Describe the visible saved-note surface, archived PDF routes, delete boundary, and the source-bounded rank boundary \\
