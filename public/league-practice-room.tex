...
Today note reads & Preserve current pasted notes as readable documents while showing one all-entry takeaway, date, rank, one direct description with previous-game improvement, and one PDF action per note & Describe the visible saved-note surface, archived PDF routes, and the source-bounded rank boundary \\
