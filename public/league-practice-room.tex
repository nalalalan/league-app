...
Today note read & Preserve the current pasted note as a readable document while showing one all-entry takeaway, date, rank, one direct description with previous-game improvement, and one PDF action & Describe the visible one-card surface, archived PDF routes, and the source-bounded rank boundary \\
