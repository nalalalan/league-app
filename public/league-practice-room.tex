...
The first public data source is the League practice arc supplied in the implementation thread and the public log exposed through \href{https://league.aolabs.io}{league.aolabs.io}. The current public page also exposes the May 18--19, 2026 recording manifest for \texttt{NA1-5563247854}, \texttt{NA1-5563301586}, \texttt{NA1-5563352800}, and the automatically captured \texttt{NA1-1779171677800} review clip: twelve short highlight files, four full-review files, poster frames, local queue metadata, local client K/D/A and CS when available, per-recording feedback, and one main queue focus. Public Riot API match history is not imported in this version.
