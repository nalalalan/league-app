...
On May 18, 2026, the public page added a generated recordings manifest from the local League of Legends Highlights folder. The current manifest contains 15 recordings across matches \texttt{NA1-5563247854}, \texttt{NA1-5563301586}, and \texttt{NA1-5563352800}. The set totals 21:21 of video and includes short highlight clips plus three longer full-review recordings. Champion detection was bounded to visible replay evidence: sampled frames show Samira in the team list and center the Soul Fighter Samira model and nameplate. No other player champion was treated as source-confirmed for this recording set.

The recording review does not attempt to become a full coaching dashboard. The public surface now keeps champion cards first, then gives one Samira focus, then lists medium playable recordings with information on the left and video on the right. Each row gives the match time, queue type, replay timestamp, champion, length, one takeaway, one fuller description, and the playable video. Rows are sorted with the newest match first and, within a match, the longest recording first. After manual storyboard review of the newest full recording, the current Samira target is ``name the payout before the dash'': before E/R, the player names wave, tower, dragon, recall, or nexus; if none is real, the dash waits. The row keeps the evidence basis compact so the advice remains tied to replay evidence without turning the first screen into a wall of coaching text.
