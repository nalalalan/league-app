...
function manualFeedback(file) {
  if (file === "auto_NA1-5563660362_01.mp4") {
    return {
      ...
      gameDetail: "Around 12:06, the clip is already in the fun part: your team has broken into the enemy base, Garen is walking in first, and Samira is hovering close enough to help without needing to start the fight. Around 13:06, Mordekaiser crosses mid and Samira turns with the team, which keeps the pressure pointed back toward their base instead of drifting into a random side adventure. By about 14:18, your frontline is back on structures, the enemy side is running out of bodies, and the game ends because your team keeps walking through the same open door. Master focus: when the base is cracked, stay with the ending push, hit the thing that ends the game, and only chase if the chase protects that ending.",
